<template>
  <form class="form-start" @submit.prevent="handleJoinRoom" v-if="!isJoinRoom">
    <input type="text" v-model="username" placeholder="Username" />
    <input type="text" v-model="room" placeholder="Room name" />
    <button>Join</button>
  </form>
  <section class="msger" v-if="isJoinRoom">
    <header class="msger-header">
      <div class="msger-header-title">
        <i class="fas fa-comment-alt"></i> {{ room }}
      </div>
    ...
    <main ref="messageContainer" class="msger-chat">
      <div
        ...
        class="msg"
        :class="[
          { 'right-msg': m.user === username },
          { 'left-msg': m.user !== username },
        ]"
      >
        <div
          class="msg-img"
        ...
        <div class="msg-bubble">
          <div class="msg-info">
            <div class="msg-info-name">{{ m.user }}</div>
...
const handleSendMessage = () => {
  ...
  chatHub.emit("SendMessage", message.value);
  message.value = "";
};

onMounted(() => {
  chatHub.on("ReceiveMessage", (data: { user: string; message: string }) => {
